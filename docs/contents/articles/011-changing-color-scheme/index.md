...
We tried to make the process of changing color scheme in InnSuites as easy as possible. 

By default InnSuites has two color profiles: mint and blur.
This article will help you to create your own color profile.
Let's say you want to make InnSuites dark.
